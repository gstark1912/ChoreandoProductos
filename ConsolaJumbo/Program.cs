...
namespace ConsolaJumbo
{
    class Program
    {
        ...
        private static void SaveArticleData(int num)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsJsonAsync("https://www.jumbo.com.ar/Comprar/HomeService.aspx/ObtenerArticulosPorDescripcionMarcaFamiliaLevex", myObject).Result;
    ...
    class A
    {
        ...
        public Byte ordenamiento { get; set; }
